					...
					<form method="POST" action="{{ route('products.store') }}">
						...
						<div class="billing-fields">
							...
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
									<div class="single-register">
											...
											<input type="text" id="datepicker" class="@error('publish_date') is-invalid @enderror" name="publish_date" value="{{ old('publish_date') }}" required autocomplete="publish_date" autofocus>
											@error('publish_date')
	                                    	<span class="invalid-feedback" role="alert">
	                                        	<strong>{{ $message }}</strong>
	                                    	</span>
							...
							<div class="single-register">
									...
									<input type="text" id="currency" placeholder="VND" class="@error('price') is-invalid @enderror" name="price" value="{{ old('price') }}" required autocomplete="price" autofocus>
									@error('price')
	                                <span class="invalid-feedback" role="alert">
	                                    <strong>{{ $message }}</strong>
	                                </span>
